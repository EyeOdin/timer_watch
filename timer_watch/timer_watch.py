...
class TimerWatchDocker(DockWidget):
    ...
    def Info_Display(self):
        ...
        if ad == None : # No Document is Active
    ...
    def Info_Document(self):
        ...
        if editing_time == "Editing Time" or editing_time == None:
            editing_time = "None"
            active_time = "Unaware"
        else :
            ...
            secondNN = minuteRR
            active_time = str(yearNN)+"y "+str(monthNN)+"m "+str(dayNN)+"d . "+str(hourNN)+"h "+str(monthNN)+"m "+str(secondNN)+"s work"
